"""
This program generates (or updates) a OtherTree Sprig's manifest by scanning the supplied path to a folder of protocol buffers.
It proceeds to output this manifest to the given file.
